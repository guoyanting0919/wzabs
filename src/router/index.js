  ...
  new VueRouter({
    ...
    routes: [
...

      {
        ...
        component: () => import("../views/FormModel/Edit.vue"),
      },
      ...
      {
        path: "/Activity/NewEdit",
        name: "ActivityNewEdit",
        show: false,
        meta: {
          title: "活動新增&編輯",
          NoTabPage: true,
        },
        component: () => import("../views/Activity/NewEdit.vue"),
      },

      {
        path: "/Activity/IdentificationCard",
        name: "ActivityIdentificationCard",
        show: false,
        meta: {
          title: "識別證",
        },
        component: () => import("../views/Activity/IdentificationCard.vue"),
      },
      ...
      {
        path: "/IndividualStatement/List",
        name: "IndividualStatementList",
        show: false,
        meta: {
          title: "個資同意書",
        },
        component: () => import("../views/IndividualStatement/List.vue"),
      },

      {
        ...
        component: () => import("../views/Other/Carousel.vue"),
      },
...
router.beforeEach((to, from, next) => {
  ...
  // 設定網頁 title
  if (to.meta.title) {
    document.title = `文藻活動後臺-${to.meta.title}`;
  }
